...
<html>
    ...
    <body>        
        ...
        <div id = "main">
            ...
            <div id = "content">                
                <?php                       
                        require("shop_subsites/products_2.php");
                //Cart things
                        ...
                        if(isset($_GET['view_product'])){
                            ...
                            echo "<div class = 'product_spec'>  
                                 ...
                                 <p>
                                    <form action='./shop_2.php' method='post'> 
                ...
                //Site display
                        ...
                        //Checkout
                            ...
                            if(empty($_SESSION['shopping_cart'])){
                                ...
                                echo "<form action = './shop_2.php?checkout=1' method = 'post'>";     
                        ...
                        //View all products
                            ...
                            foreach($products as $id => $products){                                
                                echo "<a href = './shop_2.php?view_product=$id'><div class = 'product_container'><br/><p>"
                                     .$products['name']."<br/>
