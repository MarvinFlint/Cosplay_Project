...
<html>
    ...
    <body>
        ...
        <div id = "main">
            ...
            <div id = "content">                
               <h1>Bitte wähle ein Cosplay aus!</h1>
               <a href = "Cosplay_Subsites/HarleyQuinn.php" ><div class = "cosplay_name">Harley Quinn</div></a>
               <a href = "Cosplay_Subsites/InsaneAhri.php" ><div class = "cosplay_name">Insane Ahri</div></a>
               <a href = "Cosplay_Subsites/LeBlanc.php" ><div class = "cosplay_name">LeBlanc</div></a>
               <a href = "Cosplay_Subsites/ProjectYi.php" ><div class = "cosplay_name">PROJECT: Yi</div></a>
               <a href = "Cosplay_Subsites/PoolpartyAhri.php" ><div class = "cosplay_name">Poolparty Ahri</div></a>
               <a href = "Cosplay_Subsites/SlayBelleKata.php" ><div class = "cosplay_name">Slay Belle Katarina</div></a>
               <a href = "Cosplay_Subsites/Tardis.php" ><div class = "cosplay_name">Tardis</div></a>
